...
class MyRoutes {
  ...
  static const profileScreeen = "/profile";
  static const earnMoreScreen = "/earnMore";
}
...
class Pages {
  ...
  static final routes = [
    ...
    GetPage(
        name: MyRoutes.profileScreeen,
        page: () => NewProfileScreenPage(),
        bindings: [ProfileBindings()]),
    GetPage(
        name: MyRoutes.earnMoreScreen,
        page: () => const EarnMorePage(),
        bindings: [EarnBinding()]),
    GetPage(
