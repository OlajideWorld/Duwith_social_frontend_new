import 'package:duwith_social/Pages/Media%20Page/components/media_list_widget.dart';
...
class MediaVideoPlayerWidget4 extends StatefulWidget {
  final PostForYou post;
  final bool isActive;
  final double width;
  final int type;
  const MediaVideoPlayerWidget4(
      {super.key,
      required this.post,
  ...
  @override
  State<MediaVideoPlayerWidget4> createState() =>
      _MediaVideoPlayerWidget2State();
}

class _MediaVideoPlayerWidget2State extends State<MediaVideoPlayerWidget4> {
  ...
  @override
  void didUpdateWidget(MediaVideoPlayerWidget4 oldWidget) {
