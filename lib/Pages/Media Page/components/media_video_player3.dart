...
class MediaVideoPlayerWidget3 extends StatefulWidget {
  final PostForYou post;
  final bool isActive;
  final double width;
  final int type;
  const MediaVideoPlayerWidget3(
      {super.key,
      required this.post,
  ...
  @override
  State<MediaVideoPlayerWidget3> createState() =>
      _MediaVideoPlayerWidget2State();
}

class _MediaVideoPlayerWidget2State extends State<MediaVideoPlayerWidget3> {
  ...
  @override
  void didUpdateWidget(MediaVideoPlayerWidget3 oldWidget) {
