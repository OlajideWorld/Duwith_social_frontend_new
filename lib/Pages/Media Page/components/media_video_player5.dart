...
class MediaVideoPlayerWidget5 extends StatefulWidget {
  final PostForYou post;
  final bool isActive;
  final double width;
  final int type;
  const MediaVideoPlayerWidget5(
      {super.key,
      required this.post,
  ...
  @override
  State<MediaVideoPlayerWidget5> createState() =>
      _MediaVideoPlayerWidget2State();
}

class _MediaVideoPlayerWidget2State extends State<MediaVideoPlayerWidget5> {
  ...
  @override
  void didUpdateWidget(MediaVideoPlayerWidget5 oldWidget) {
