...
import '../../../Services/Ads Service/start_app_manager.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        ...
        // });
        if (homeController.startRewardedVideoAd != null) {
          homeController.startRewardedVideoAd!.show().then((shown) {
            if (shown) {
