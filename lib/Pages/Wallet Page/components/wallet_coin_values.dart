  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        walletCoinDetails("assets/images/social.png", "Duwith coin", 12000.14,
            "1.2", Colors.red, true),
        SizedBox(height: heightSize(12)),
        walletCoinDetails("assets/images/social.png", "Luna coin", 1000.14,
  ...
  return SizedBox(
    ...
    child: Column(
      children: [
        ...
        Divider(height: heightSize(3), thickness: 1, color: Color(0xFF3C3C3C)),
      ],
    ),
  );
}
