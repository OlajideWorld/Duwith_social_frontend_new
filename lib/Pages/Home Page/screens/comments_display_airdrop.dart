...
class CommentsDisplayAirdropBottomSheet extends StatefulWidget {
  final String postId;
  const CommentsDisplayAirdropBottomSheet({
    super.key,
    required this.postId,
  });

  @override
  State<CommentsDisplayAirdropBottomSheet> createState() =>
      _CommentsDisplayAirdropBottomSheetState();
}

class _CommentsDisplayAirdropBottomSheetState
    extends State<CommentsDisplayAirdropBottomSheet> {
            ...
            SizedBox(
              child: Column(
                ...
                children: [
                  ...
                  CText(
                    text: "${homeController.commentsAirdrop.length} Comments",
                    size: 18,
                  ...
                  homeController.loadingComment.value == true
                      ...
                      : homeController.commentsAirdrop.isEmpty
                          ? const SizedBox()
                          : Expanded(
                                  ...
                                  itemBuilder: (context, index) {
                                    return commentsListView(
                                        ...
                                        homeController.commentsAirdrop
                                            .value[index], () async {
                                      await socketService.likeAirdropComment(
                                          homeController
